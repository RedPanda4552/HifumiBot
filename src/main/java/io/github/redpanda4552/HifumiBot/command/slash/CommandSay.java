...
public class CommandSay extends AbstractSlashCommand {
  ...
  protected CommandData defineSlashCommand() {
    SubcommandData something =
        new SubcommandData("something", "Make the bot say something")
            .addOption(OptionType.STRING, "string", "String content to say", true);
    SubcommandData edit =
        new SubcommandData("edit", "Edit something the bot has said")
    ...
    SubcommandData get =
        new SubcommandData("get", "Get the raw message content from something the bot has said")
  ...
  private void requiredArgStop(SlashCommandInteractionEvent event) {
    Messaging.logInfo(
        "CommandSay",
        "onExecute",
        "Missing required argument, command may have been tampered with.\nUser = "
